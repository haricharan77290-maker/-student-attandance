...
export function OrbitIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
...
export function CheckAllIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="18 6 9 17 4 12" />
      <polyline points="22 10 13 21 10 18" />
    </svg>
  );
}
